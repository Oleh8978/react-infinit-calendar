  ...
  return (
    <div className="internet-connection">
        <div className="internet-connection_top">
            <span className="internet-connection_top-header">Looks like You are offline</span>
            <span className="internet-connection_top-subheader">We couldn’t load this page</span>
